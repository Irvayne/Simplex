...
public class Principal {
	...
	private static int testeDaRazao(double tablo[][],
	...
	private static int retornaIndiceParaEntrarMIN(double custosAssociados[], int base[]){
	...
	private static int retornaIndiceParaEntrarMAX(double custosAssociados[]){
		double valor = -100000;
		int indice = -1;
	...
	private static void pivoteia(double tablo[][],
	...
	private static int[] geraBaseInicial(int linha, int coluna) {
	...
	private static double[] geraCustos(double[] objetivo, int i) {
	...
	private static double[][] geraTablo(double[][] restricoes, int m, int n) {
